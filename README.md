...
- 사운드: ZzFX(MIT) 런타임 합성 SFX 10종(단서 획득/동요/폭로/판정/상신/부팅 등) — 에셋 파일 0개, 우하단 「사운드」 토글, 미지원 환경 무음 폴백
...
- `src/ui/sfx.ts, sfx-params.ts, vendor/zzfx.js` — 레트로 SFX (ZzFX MIT 벤더링, 런타임 파형 합성)
